    ...
    <>
          ...
          <div ref={timelineRef} className="flex flex-col">
            {experience.map((item, index) => (
              <div
                ...
                style={{
                  borderTop: "1px solid rgba(236,234,229,0.06)",
                  color: "#eceae5",
                  padding: "2rem 0",
                }}
              >
            ...
            <div style={{ borderTop: "1px solid rgba(236,234,229,0.06)" }} />
          </div>
        </div>
      </section>
      ...
      >
        <div className="mx-auto max-w-7xl">
          ...
          >
            <span ref={counterRef} className="js-counter">50+</span>
            {" "}{isFr ? "Domaines Immobiliers" : "Real Estate Domains"}
          </h2>
